...
* @throws ApiError
*/
export const useTaskLogStreamServiceStreamTaskLog = <TData = Common.TaskLogStreamServiceStreamTaskLogDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ dagId, dagRunId, mapIndex, resumeToken, taskId, tryNumber }: {
  dagId: string;
  dagRunId: string;
  mapIndex?: number;
  resumeToken?: string;
