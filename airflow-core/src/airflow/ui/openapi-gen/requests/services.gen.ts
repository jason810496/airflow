...
export class TaskLogStreamService {
     ...
     * @throws ApiError
     */
    public static streamTaskLog(data: StreamTaskLogData): CancelablePromise<StreamTaskLogResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/ui/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/logs/{try_number}/stream',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId,
                task_id: data.taskId,
