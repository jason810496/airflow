...
def get_provider_info():
    return {
        ...
        "remote-logging": [
            {
                "scheme": "s3",
                "factory": "airflow.providers.amazon.aws.log.remote_log_factory.remote_log_io_factory",
            },
            {
                "scheme": "cloudwatch",
                "factory": "airflow.providers.amazon.aws.log.cloudwatch_remote_log_factory.remote_log_io_factory",
            },
        ],
        "config": {
            "aws": {
