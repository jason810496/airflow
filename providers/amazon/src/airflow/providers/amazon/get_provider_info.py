...
def get_provider_info():
    return {
        ...
        "remote-logging": [
            {
                "schemes": ["s3"],
                "factory": "airflow.providers.amazon.aws.log.s3_task_handler.build_remote_log_io",
            },
            {
                "schemes": ["cloudwatch"],
                "factory": "airflow.providers.amazon.aws.log.cloudwatch_task_handler.build_remote_log_io",
            },
        ],
        "config": {
            "aws": {
