...
class TestOpensearchRemoteLogIOStreaming:
    ...
    def _setup(self, tmp_path, monkeypatch):
        ...
        self.io._write_to_opensearch = fake_write
    ...
    def test_processors_empty_when_no_write_mode_enabled(self, tmp_path):
        io = OpensearchRemoteLogIO(host="localhost", port=9200, base_log_folder=tmp_path)
    ...
    def test_write_stdout_streams_and_upload_does_not_duplicate(self, ti, capsys):
        ...
        self.io.write_to_opensearch = False
