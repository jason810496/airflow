...
.. toctree::
    ...
    PyPI Repository <https://pypi.org/project/apache-airflow-providers-common-messaging/>
...
This package is for the ``common.messaging`` provider.
All classes for this package are included in the ``airflow.providers.common.messaging`` python package.
