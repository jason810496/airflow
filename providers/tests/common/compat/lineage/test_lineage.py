...
from airflow.providers.common.compat.lineage import AUTO, apply_lineage, get_backend, prepare_lineage
...
class TestLineage:
    ...
    @mock.patch("airflow.providers.common.compat.lineage.get_backend")
    ...
    @conf_vars(
        {("lineage", "backend"): "providers.tests.common.compat.lineage.test_lineage.CustomLineageBackend"}
    )
