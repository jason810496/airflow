...
ALL_SKIPPED_COMMITS_ON_NO_CI_IMAGE = (
    ...
    "mypy-shared-serialization,mypy-shared-template_rendering,mypy-shared-timezones,mypy-shared-workloads,mypy-task-sdk,mypy-task-sdk-integration-tests,"
...
ALL_SKIPPED_COMMITS_IF_NO_HELM_TESTS = (
    ...
    "mypy-shared-module_loading,mypy-shared-observability,mypy-shared-plugins_manager,"
    "mypy-shared-providers_discovery,mypy-shared-secrets_backend,mypy-shared-secrets_masker,"
    "mypy-shared-serialization,mypy-shared-template_rendering,mypy-shared-timezones,mypy-shared-workloads,mypy-task-sdk,mypy-task-sdk-integration-tests,update-uv-lock"
)
            ...
            pytest.param(
                ("task-sdk/src/airflow/sdk/random.py",),
                {
                    ...
                    "skip-prek-hooks": (
                        ...
                        "mypy-shared-module_loading,mypy-shared-observability,mypy-shared-plugins_manager,"
                        "mypy-shared-providers_discovery,mypy-shared-secrets_backend,mypy-shared-secrets_masker,"
                        "mypy-shared-serialization,mypy-shared-template_rendering,mypy-shared-timezones,mypy-shared-workloads,mypy-task-sdk-integration-tests,"
                        "ts-compile-lint-simple-auth-manager-ui,ts-compile-lint-ui,update-uv-lock"
                    ),
                    "skip-providers-tests": "false",
                    "upgrade-to-newer-dependencies": "false",
            ...
            pytest.param(
                ("task-sdk-integration-tests/tests/airflow/sdk/random.py",),
                {
                    ...
                    "skip-prek-hooks": (
                        ...
                        "mypy-shared-module_loading,mypy-shared-observability,mypy-shared-plugins_manager,"
                        "mypy-shared-providers_discovery,mypy-shared-secrets_backend,mypy-shared-secrets_masker,"
                        "mypy-shared-serialization,mypy-shared-template_rendering,mypy-shared-timezones,mypy-shared-workloads,mypy-task-sdk,"
                        "ts-compile-lint-simple-auth-manager-ui,ts-compile-lint-ui,update-uv-lock"
                    ),
                    "skip-providers-tests": "true",
                    "upgrade-to-newer-dependencies": "false",
            ...
            pytest.param(
                ("shared/logging/src/airflow_shared/logging/remote.py",),
                {
                    "skip-prek-hooks": (
                        ...
                        "mypy-shared-timezones,mypy-shared-workloads,mypy-task-sdk,mypy-task-sdk-integration-tests,"
                        "ts-compile-lint-simple-auth-manager-ui,ts-compile-lint-ui,update-uv-lock"
                    ),
                },
